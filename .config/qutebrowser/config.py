...
config.bind('bb', 'config-cycle statusbar.show always never')
c.tabs.show = 'never'
c.statusbar.show = 'never'  # 或者用快捷键切换：config-cycle statusbar.show always never

# 设置默认搜索引擎为百度或谷歌
c.url.searchengines = {'DEFAULT': 'www.google.com{}', 'baidu': 'www.baidu.com{}', 'duck': 'duckduckgo.com{}'}
# 设置启动时自动打开的页面（可以是一个列表，打开多个标签）
c.url.start_pages = ['https://www.google.com/search?udm=50&aep=11']
# 设置新建空标签页（如按下 'n'）时的默认页面
c.url.default_page = 'https://www.google.com/search?udm=50&aep=11'
...
c.colors.statusbar.url.success.http.fg = '#98c379'  # 成功加载

# 设置状态栏/命令行的字体和大小
# 格式为: "[字重] [字号]pt [字体家族]"
c.fonts.statusbar = '18pt "Adwaita Sans"'
c.fonts.completion.entry = '18pt "Adwaita Sans"'
c.zoom.default = 125

c.colors.completion.even.bg = '#0E1011'
c.colors.completion.odd.bg = '#0E1011'
c.colors.completion.fg = '#7895Af'
c.colors.completion.item.selected.bg = '#202022'
c.colors.completion.item.selected.fg = '#ffffff'
# 选中项顶部边框颜色
c.colors.completion.item.selected.border.top = '#AEB2B7'

# 选中项底部边框颜色
c.colors.completion.item.selected.border.bottom = '#AEB2B7'


c.colors.completion.category.bg = '#0E1011'
